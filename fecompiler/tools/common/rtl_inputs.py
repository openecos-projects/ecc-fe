...
def write_generated_rtl_filelist(filelist_path: Path, sources: list[str]) -> Path:
    ...
    lines = ["# Generated by ecc-fe from selected CPU RTL files"]
    if rtl_sources_provide_difftest_adapter(resolved):

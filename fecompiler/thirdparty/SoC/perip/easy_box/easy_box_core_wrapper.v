module core_wrapper (
  ...
  // Custom CPUs use the flat YSYX BlackBox interface. Bundled adapters keep
  // the legacy ECOS cpu_top interface below.
...
`ifdef ECOS_CUSTOM_CPU_TOP
  `ECOS_CUSTOM_CPU_TOP u_core (
    .clock              (clock),
    .reset              (reset),

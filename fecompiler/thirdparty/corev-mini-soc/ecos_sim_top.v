// Core-V oriented minimal ECOS RISC-V SoC harness.
//
// This wrapper keeps the same simulator-facing ecos_sim_top contract as the
// other ECOS frontend SoC harnesses while remaining intentionally small.  It is
// useful for experimenting with open-source CPU wrappers such as CV32E40P
// before a richer platform-specific SoC is integrated.

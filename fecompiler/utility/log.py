"""Logging utilities — mirrors chipcompiler/utility/log.py."""
...
def build_timestamped_log_file(log_file: str, pid: int | None = None) -> str:
    ...
    Example::
        ...
        /tmp/fecompiler-api-server.log
        -> /tmp/fecompiler-api-server-20260211-090428-12345.log
    """
...
class Logger:
    """Thin wrapper around :mod:`logging` with rotating-file support."""
    ...
    def __init__(
        ...
        if not self.logger.handlers:
            ...
            console_handler.setLevel(
                logging.WARNING if console_level is None else console_level
            )
    ...
    def log_separator(self, max_len: int = 60) -> None:
        self.logger.info('#' * max_len)

    def log_section(self, section: str, max_len: int = 60) -> None:
...
def create_logger(
    ...
    """Create and return a :class:`Logger` instance."""

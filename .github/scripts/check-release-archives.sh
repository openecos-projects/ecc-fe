...
require_entry "${examples_archive}" "ecc-fe-examples-latest/examples/cl3/cl3_verilog/CL3Top.sv"
require_entry "${examples_archive}" "ecc-fe-examples-latest/examples/cl3_std/filelist.cpu.f"
require_entry "${examples_archive}" "ecc-fe-examples-latest/examples/cl3_std/cl3_verilog/CL3Top.sv"
